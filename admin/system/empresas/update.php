<div class="content form_create">
    ...
    <article>
        ...
        if ($data && $data['SendPostForm']):
            ...
            if ($data['empresa_capa'] == null):
                unset($data['empresa_capa']);
            endif;
        ...
        if ($checkCreate && empty($cadastra)):
            WSErro("A empresa <b>{$data['empresa_title']}</b> foi atualizada com sucesso no sistema!", WS_ACCEPT);
        endif;
        ?>
        ...
        <form name="PostForm" action="" method="post" enctype="multipart/form-data">
            ...
            <label class="label">
                <span class="field">Logo da empresa: <small style="float: right;">Exatamente 578 x 288px (JPG ou PNG)</small></span>
            ...
            <div class="label_line">
                <label class="label_medium">
                    ...
                    <input type="url" placeholder="http://www.codebrsolucoes.com" name="empresa_site" value="<?php if (isset($data['empresa_site'])) echo $data['empresa_site']; ?>" />
                </label>

                <label class="label_medium">
                    <span class="field">Facebook Page:</span>
                    <input type="text" placeholder="codebrDigital" name="empresa_facebook" value="<?php if (isset($data['empresa_facebook'])) echo $data['empresa_facebook']; ?>" />
                </label>                
            </div><!-- line -->
