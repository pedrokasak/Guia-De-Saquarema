<div class="content list_content">
    ...
    <section>
        ...
        if ($empty):
            WSErro("Opsss, Você tentou editar um post que não existe no sistema", WS_INFOR);
        endif;
        ...
        if ($action):
            ...
            switch ($action):
                ...
                default :
                    WSErro("Ação não foi identificada no sistema, favor utilize os botões!", WS_ALERT);
            endswitch;
        endif;
        ...
        if ($readPosts->getResult()):
            ...
            $Pager->ReturnPage();
            WSErro("Desculpe, ainda não existe posts cadastrados", WS_INFOR);
