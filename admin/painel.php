    ...
    <body class="painel">
        ...
        <header id="navadmin">
            <div class="content">
                ...
                <h1 class="logomarca">Gerenciador de Conteúdo</h1>
        ...
        <div id="painel">
            ...
            if (file_exists($includepatch)):
                ...
                WSErro("<b>Erro ao incluir:</b> o controller /{$getexe}.php!", WS_ERROR);
                echo "</div>";
            endif;
            ?>
        </div> <!-- painel -->
        ...
        <footer class="main_footer">
            <a href="http://www.saquatech.com" target="_blank" title="SaquaTech">&copy; SaquaTech - Todos os Direitos Reservados</a>
        </footer>
