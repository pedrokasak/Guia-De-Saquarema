...
<div class="site-container">
    ...
    <article class="page_article">
        ...
        <div class="art_content">
            ...
            <!--CONTEUDO-->
            <div class="htmlchars">
                <div class="fb-like" data-href="http://www.guiadesaquarema.com.br/artigo/#post_cover#&w=460&h=230" data-layout="standard" data-action="like" data-size="small" data-show-faces="true" data-share="true"></div>
                <?= $post_content; ?>
                ...
                if ($readgb->getResult()):
                    ...
                    <section class="gallery">
                        <hgroup>
                            <h3>
                                GALERIA:
                                <p class="tagline">Veja fotos em <mark> <?php $post_title; ?></mark></p>
                            </h3>
                        </hgroup>
            ...
            <?php
            $readMore = new Read;
            $readMore->ExeRead("ws_posts", "WHERE post_status = 1 AND post_id != :id AND post_category = :cat ORDER BY rand() LIMIT 4", "id={$post_id}&cat={$post_category}");
            if ($readMore->getResult()):
                ...
                <article class="content">
                    ...
                    <div class="fb-comments" data-href="http://guiadesaquarema.com.br/artigo/<?php $Link;?>" mobile="data-mobile" data-numposts="1"data-order-by="social" data-mobile></div>
                </article>
            <?php endif; ?>
